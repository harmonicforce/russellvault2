...
- `main` is the canonical branch and the Railway deployment branch. Verify its current head before changing code.
...
- Do not deploy, alter Railway or live Supabase, merge, or transfer authority unless the work order explicitly authorizes it.
