...
select is(
  ...
  76,
  'seventy-six migrations are recorded, one per file in supabase/migrations'
);
...
select results_eq(
  ...
  'the migration ledger matches every governed migration through S2.4.1 cost-basis hardening'
);
